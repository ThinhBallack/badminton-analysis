...
def main():
    # Read Video
    input_video_path = "input_videos/DoubleServe.mp4"
    video_frames = read_video(input_video_path)

    # Detect Players and Ball
    player_tracker = PlayerTracker(model_path='yolov8x')
    ball_tracker = BallTracker(model_path='models/best03072024_BEST.pt')
    ...
    court_model_path = "models/pretrained_keypoints_model_best.pth"
    ...
    for ball_shot_ind in range(len(ball_shot_frames)-1):
        ...
        opponent_player_id = 1 if player_shot_ball == 5 or player_shot_ball == 4 else 5
        print(opponent_player_id)
