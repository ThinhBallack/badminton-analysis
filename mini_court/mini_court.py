...
class MiniCourt():
    ...
    def convert_bounding_boxes_to_mini_court_coordinates(self,player_boxes, ball_boxes, original_court_key_points ):
        player_heights = {
            1: constants.PLAYER_BOTTOM1_HEIGHT_METERS,
            2: constants.PLAYER_BOTTOM2_HEIGHT_METERS,
            5: constants.PLAYER_TOP1_HEIGHT_METERS,
            4: constants.PLAYER_TOP2_HEIGHT_METERS
        }
